...
import style from "../../styles/components/faqs.module.scss";

export default function FAQs() {
  return (
    <Accordion allowToggle className={style.faqs}>
      <AccordionItem>
        <AccordionButton>
          <Box flex="1" textAlign="left" fontWeight="600">
            <h2>What is Liquidity Providing (LP)?</h2>
          </Box>
          <AccordionIcon />
        </AccordionButton>
        <AccordionPanel pb={4}>
      ...
      <AccordionItem>
        <AccordionButton>
          <Box flex="1" textAlign="left" fontWeight="600">
            <h2>How do I stake my RBN tokens?</h2>
          </Box>
          <AccordionIcon />
        </AccordionButton>
        <AccordionPanel pb={4}>
      ...
      <AccordionItem>
        <AccordionButton>
          <Box flex="1" textAlign="left" fontWeight="600">
            <h2>How do I claim my rewards?</h2>
          </Box>
          <AccordionIcon />
        </AccordionButton>
        <AccordionPanel pb={4}>
      ...
      <AccordionItem>
        <AccordionButton>
          <Box flex="1" textAlign="left" fontWeight="600">
            <h2>
              I don't see my Uniswap LP position on the Uniswap website anymore.
              Why?
            </h2>
          </Box>
          <AccordionIcon />
        ...
        <AccordionPanel pb={4}>
          <Text>
            When you stake your NFT, your NFT will be temporarily held on the
            Staker contract. This gives it the ability to earn RBN rewards for
            providing liquidity. When you Exit, the NFT will be returned back to
            your wallet.
          </Text>
          <br />
          <Text>
            To see details of the position, click the 'Token ID' link on the
      ...
      <AccordionItem>
        <AccordionButton>
          <Box flex="1" textAlign="left" fontWeight="600">
            <h2>Is this an official site?</h2>
          </Box>
          <AccordionIcon />
        </AccordionButton>
        <AccordionPanel pb={4}>
